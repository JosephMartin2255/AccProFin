...
urlpatterns = [
 ...
 #  ----------------------------- TINTO urls LOAN  END-----------------------------
   ...
   path('Fin_PurchaseOrderByVendor',views.Fin_PurchaseOrderByVendor, name='Fin_PurchaseOrderByVendor'),
   path('Fin_Share_PurchaseOrderByVendor',views.Fin_Share_PurchaseOrderByVendor, name='Fin_Share_PurchaseOrderByVendor'),
   path('Fin_Customize_PurchaseOrderByVendor',views.Fin_Customize_PurchaseOrderByVendor, name='Fin_Customize_PurchaseOrderByVendor'),
